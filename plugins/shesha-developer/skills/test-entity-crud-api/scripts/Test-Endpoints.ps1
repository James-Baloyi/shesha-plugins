...
# NOTE: This list is auto-generated by Run-EndpointTests.ps1 -UpdateEntities
# Run with -UpdateEntities flag to scan the Domain folder and update this list
$Entities = @(
    @{ Type = "LandBank.Crm.Domain.Verifications.AmlVerificationEntity"; Name = "AmlVerificationEntit" }
    @{ Type = "LandBank.Crm.Domain.Verifications.AmlVerificationIndividual"; Name = "AmlVerificationIndiv" }
    @{ Type = "LandBank.Crm.Domain.Verifications.ApiCallLog"; Name = "ApiCallLog" }
    @{ Type = "LandBank.Crm.Domain.Verifications.ApiCallRequest"; Name = "ApiCallRequest" }
    @{ Type = "LandBank.Crm.Domain.Verifications.Buyer"; Name = "Buyer" }
    @{ Type = "LandBank.Crm.Domain.Verifications.CIPCVerification"; Name = "CIPCVerification" }
    @{ Type = "LandBank.Crm.Domain.Verifications.DEEDSOfficeVerification"; Name = "DEEDSOfficeVerificat" }
    @{ Type = "LandBank.Crm.Domain.Verifications.DirectorVerification"; Name = "DirectorVerification" }
    @{ Type = "LandBank.Crm.Domain.Verifications.EntityApplicationVerification"; Name = "EntityApplicationVer" }
    @{ Type = "LandBank.Crm.Domain.Verifications.GlobalSanctionsVerification"; Name = "GlobalSanctionsVerif" }
    @{ Type = "LandBank.Crm.Domain.Verifications.IDVerification"; Name = "IDVerification" }
    @{ Type = "LandBank.Crm.Domain.Verifications.KYCVerification"; Name = "KYCVerification" }
    @{ Type = "LandBank.Crm.Domain.Accounts.LBAccount"; Name = "LBAccount" }
    @{ Type = "LandBank.Crm.Domain.Contacts.LBContact"; Name = "LBContact" }
    @{ Type = "LandBank.Crm.Domain.Organizations.LBOrganization"; Name = "LBOrganization" }
    @{ Type = "LandBank.Crm.Domain.LoanApplications.LoanApplication"; Name = "LoanApplication" }
    @{ Type = "LandBank.Crm.Domain.Organizations.OrganizationDirector"; Name = "OrganizationDirector" }
    @{ Type = "LandBank.Crm.Domain.Verifications.PEPVerification"; Name = "PEPVerification" }
    @{ Type = "LandBank.Crm.Domain.Verifications.PersonalApplicationVerification"; Name = "PersonalApplicationV" }
)
